...
class AlreadyExistsError(BaseError):
    def __init__(
        self, *_: tuple[Any], message: str = "Resource Already Exists"
    ) -> None:
        """Any internally defined database error
        have to raise this exception.
        """
...
class RateLimitExceededError(BaseError):
    def __init__(
        self, *_: tuple[Any], message: str = "Too many requests. Please try again later."
    ) -> None:
        '''The error raised when a user exceeds the allowed request rate.'''
