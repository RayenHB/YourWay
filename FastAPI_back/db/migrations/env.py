...
from admin_manager.models import *
from phone_case_manager.models import *
...
config.set_main_option("sqlalchemy.url", get_app_settings().database_url.unicode_string())
